...
<head>
    ...
    <title>In ra dãy số lẻ</title>
</head>
<body>
    <div class="flex  justify-content-center">
        <div>
            <section>
                <h1 class="head-title text-center">Đề bài: In ra dãy số lẻ</h1>
                <div>Chi tiết đề bài:
                    <ul>
                        <li>In ra dãy số lẻ giới hạn bởi n</li>
                    </ul>
                </div> 
            </section>
            <section>
                ...
                <div style="width: 250px;margin:0 auto;overflow-y:scroll;max-height:270px;">
                    <?php
                        if($submited){
                            $sum=0;
                            for($i=0;$i<=$numb;$i++){if($i%2){echo $i;if($i<$numb-1)echo ", ";$sum+=$i;}}
                        }
                    ?>
                </div>
                <div>
